...
macro(copy_assets_to_android_proj)
    ...
    file(COPY "${PROJECT_SOURCE_DIR}/Media/models" DESTINATION "${NDKOUT}/app/src/main/assets")
    file(COPY "${PROJECT_SOURCE_DIR}/Media/particle" DESTINATION "${NDKOUT}/app/src/main/assets")
    file(COPY "${PROJECT_SOURCE_DIR}/Media/thumbnails" DESTINATION "${NDKOUT}/app/src/main/assets")
    file(COPY "${PROJECT_SOURCE_DIR}/Media/packs" DESTINATION "${NDKOUT}/app/src/main/assets")
    file(COPY "${PROJECT_SOURCE_DIR}/Media/materials" DESTINATION "${NDKOUT}/app/src/main/assets")
    file(COPY "${PROJECT_SOURCE_DIR}/Media/PBR" DESTINATION "${NDKOUT}/app/src/main/assets")
    file(COPY "${PROJECT_SOURCE_DIR}/Media/DeferredShadingMedia" DESTINATION "${NDKOUT}/app/src/main/assets")
